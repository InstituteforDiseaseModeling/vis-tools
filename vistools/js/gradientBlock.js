...
$.widget("custom.gradientBlock", {
  ...
  _updateRangeSliderBackground: function(values)
  {
    ...
    var normLow = parseFloat(values[0]);
    var normHigh = parseFloat(values[1]);
  ...
  _setOption: function(key, value)
  {
    ...
    switch (key)
    {
      ...
      case "steps":
        ...
        var tooltip = this._gradient.toSourceString();
        if (this._gradient.getPreset() !== undefined)
          tooltip += ": " + this._gradient.toHexString();
        this.element.find(".gradient")
          .css("background", css)
          .attr("title", tooltip);

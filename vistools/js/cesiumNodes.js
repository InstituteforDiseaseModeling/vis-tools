...
CesiumNodes.kSelectionIndicatorUrl = "/vistools/image/PointSelectionIndicator.svg";
...
// Public functions
//------------------------------------------------------------------------------
CesiumNodes.load = function(visset, callback)
{
    ...
    if (hasColor || hasOpacity)
    {
      ...
      if (hasColor)
      {
        ...
        else
        {
          ...
          // NOTE: I stopped doing this because it breaks gradients that have
          // opacity values in the gradient. So now I just leave the color
          // alone.
        }
      }
      else

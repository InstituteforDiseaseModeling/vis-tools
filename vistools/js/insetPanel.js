...
$.widget("custom.insetPanel", {
  ...
  layoutChanged: function ()
  {
    ...
    // revert its size and location to the defaults on a window resize. Note
    // that position() won't work on hidden elements, so we have to make it
    // visible to do this.
  ...
  setState: function(state)
  {
    ...
    if (!("show" in state) || !("bounds" in state)) return; // Check object

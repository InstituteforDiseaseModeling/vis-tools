...
Geospatial.kDefaultVisSetUrl = "./defaultvisset.json";
...
//------------------------------------------------------------------------------
Geospatial.prototype._onBodyKeyDown = function(evt)
{
  var $target = $(evt.target);
...
Geospatial.prototype._onHelpClick = function(evt)
{
  ...
  var $help =
    $("<iframe class='helpContent' src='help/geospatialHelp.html'></iframe>");
...
Geospatial.prototype._checkBrowser = function()
{
  ...
  $("body").empty().append("<div class='browserFailBox'>" +
    "<div class='browserFailMessage'>Sorry, the Vis-Tools Geospatial client<br/>" +
    "does not support this browser.<br/>Please use Chrome, Firefox, or Opera." +
    "</div></div>");
...
{
  var instance = this;
  var ip = _.find(this._viewer.baseLayerPicker.viewModel.imageryProviderViewModels,
    { name: baseLayerName });

...
if __name__ == '__main__':
    ...
    vis_set.set_node_vis_type('Shapes')
    ...
    vis_set.add_binding("nodeVis", "shapeSize",
                        "InitialPopulation", "scale(50, 500)")
    vis_set.add_binding("nodeVis", "shapeExtrusion",
                        "SpatialReport_Infectious_Vectors_Count",
                        "multiply(100.0)")
    vis_set.add_binding("nodeVis", "shapeColor",
                        "SpatialReport_Infectious_Vectors_Count",
                        "stepwise(1, 'green', 2, 'orange', 3, 'gold', 'else', 'red')")

...
html_baseurl = "https://docs.idmod.org/projects/vis-tools/en/latest"
html_context = {
    'rtd_url': 'https://docs.idmod.org/projects/vis-tools/en/latest',
    "versions_dropdown": {
        "latest": "devel (latest)",
...
latex_documents = [
    (master_doc, 'vis-tools-docs.tex', u'Vis-Tools',
...
man_pages = [
    (master_doc, 'vis-tools-docs', u'Vis-Tools',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'vis-tools-docs', u'Vis-Tools',
     author, 'Institute for Disease Modeling', 'How to use the IDM Vis-Tools toolkit.',
     'Miscellaneous'),
]
